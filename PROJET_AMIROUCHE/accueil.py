...
contenu = Canvas(fen,bg='#005eff')

fontLabel = 'arial 13 bold'
fontEntre = 'arial 10 bold'

prenom = Label(contenu, text="Votre prenom :",font=fontLabel,fg='white',bg='#005eff')
nom = Label(contenu, text="Votre nom :",font=fontLabel,fg='white',bg='#005eff')
photo = Label(contenu, text="Votre photo :",font=fontLabel,fg='white',bg='#005eff')
validation = Label(contenu,text="Entrer vos informations ici",font=fontLabel,fg='#005eff',bg='white')

prenomEntre = Entry(contenu, font=fontEntre)
nomEntre = Entry(contenu, font=fontEntre)
photoEntre = Label(contenu, font='arial 8 bold',text="aucune selection",bg='#005eff',fg='white')
buttonParcourir = Button(contenu,text="Pr",command=parcourir,font=fontLabel,fg='#005eff',bg='white')
...
b1 = Button(fen,text="Validé ",command=valider,width=10,font=fontLabel,bg='#005eff',fg='white')
b2 = Button(fen,text="Renitialiser ",command=reinitialiser,width=10,font=fontLabel,bg='#005eff',fg='white')
b3 = Button(fen,text="Voir la liste ",command=lambda: listeInscrit(fen,listePersonne),width=10,font=fontLabel,bg='#005eff',fg='white')
