...
def listeInscrit(fenetre,liste):
  ...
  listeCan = Canvas(newFen,bg='#005eff')
  fontLabel='arial 11 bold'

  resultat = Label(listeCan,text="Liste des gens inscrits",font=fontLabel,fg='#005eff',bg='white')
  prenom = Label(listeCan, text="Prenom",width=15,font=fontLabel,fg='white',bg='#005eff')
  nom = Label(listeCan, text="Nom",width=6,font=fontLabel,fg='white',bg='#005eff')
  photo = Label(listeCan, text="Photo",width=12,font=fontLabel,fg='white',bg='#005eff')
  status = Label(newFen,text="Aucun inscrit pour le moment",font='arial 9 bold',fg='white',bg='#005eff')
  ...
  if liste:
    ...
    for p in liste:
      ...
      pre = Label(listeCan, text=p.prenom,font=fontLabel,fg='white',bg='#005eff')
      no = Label(listeCan, text=p.nom,font=fontLabel,fg='white',bg='#005eff')
